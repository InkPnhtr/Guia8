...
public class AhorcadoService {
    ...
    public boolean encontradas(Ahorcado Ahorc1, char x) {
        ...
        //System.out.println("Largo Pal= " + largoPal);
        int Econtradas = Ahorc1.getCantLetEnc();
        //System.out.println("Letras Encontradas= " +Econtradas);
    ...
    public void juego(Ahorcado Ahorc1) {
        do {
            ...
            //System.out.println("Intentos= " + intentos(Ahorc1));
        } while (intentos(Ahorc1) > 0);
